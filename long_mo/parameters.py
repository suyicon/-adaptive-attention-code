...
def args_parser():
    ...
    parser.add_argument('--truncated', type=int, default=15)
    parser.add_argument('--desired_T', type=int, default=10)
    ...
    parser.add_argument('--totalbatch', type=int, default=10, help="number of total batches to train; scale it with 10k")
